...
class CMakeExtension(Extension):
    ...
    def __init__(self, name, sourcedir=""):
        ...
        Args:
            name (_type_): Name
            sourcedir (str, optional): Source Directory. Defaults to "".
        """
    ...
    def build_extension(self, ext):
        ...
        if self.compiler.compiler_type != "msvc":
            ...
            if not cmake_generator:
                try:
                    import ninja  # pylint: disable=unused-import,import-outside-toplevel
...
setup(
    ...
    ext_modules=[CMakeExtension("fishsense_postcorrection_cpp")],
